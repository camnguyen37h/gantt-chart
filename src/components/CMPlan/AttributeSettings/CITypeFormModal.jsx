...
const CITypeFormModalInner = ({ form, visible, onCancel, submitting, editingRecord, onSubmit }) => {
...
const CITypeFormModal = Form.create({ name: 'ci_type_form' })(CITypeFormModalInner)
export default CITypeFormModal
